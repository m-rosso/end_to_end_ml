...
def load_models():
    ...
    """
    models = {
        "en_sm": spacy.load("ml/models/en_sm"),
        "fr_sm": spacy.load("ml/models/fr_sm"),
    }
...
@app.get("/")
def hello(user_name: UserName):
    user_name = user_name.dict()
    user_name = user_name['user_name']
    return {"message": f"Hello, {user_name}!!"}

# To run the application: uvicorn main:app --host="0.0.0.0" --port=8010 --reload
